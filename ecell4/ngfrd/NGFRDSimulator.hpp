...
public:
    ...
    static constexpr std::size_t PAIR_SPHERICAL_MAX_RETRY   = 4;
    static constexpr std::size_t PAIR_CIRCULAR_MAX_RETRY    = 4;
...
private:
    ...
    fire_domain(const DomainID& did, Domain dom)
    {
        ...
        switch(dom.kind())
        {
            ...
            case Domain::DomainKind::SingleConical:
            {
                return this->fire_single_conical(did, std::move(dom.as_single_conical()));
            }
            ...
            case Domain::DomainKind::PairCircular:
            {
                return this->fire_pair_circular(did, std::move(dom.as_pair_circular()));
            }
    ...
    boost::container::small_vector<std::pair<ParticleID, Particle>, 4>
    fire_single_conical(const DomainID& did, SingleConicalDomain dom);
    ...
    boost::container::small_vector<std::pair<ParticleID, Particle>, 4>
    fire_pair_circular(const DomainID& did, PairCircularDomain dom);
    ...
    burst_domain(const DomainID& did, Domain dom)
    {
        ...
        switch(dom.kind())
        {
            ...
            case Domain::DomainKind::PairCircular:
            {
                return this->burst_pair_circular(did,
                        std::move(dom.as_pair_circular()));
            }
            case Domain::DomainKind::Multi:
            {
    ...
    boost::container::small_vector<std::pair<ParticleID, Particle>, 4>
    burst_single_conical(const DomainID& did, SingleConicalDomain dom);
    ...
    boost::container::small_vector<std::pair<ParticleID, Particle>, 4>
    burst_pair_circular(const DomainID& did, PairCircularDomain dom);

...
class SingleSphericalDomain
{
  ...
  public:
    ...
    SingleSphericalDomain()
        : kind_(EventKind::Unknown), dt_(0.0), begin_time_(0.0),
          shell_(Sphere(Real3(0.0, 0.0, 0.0), 0.0)), gf_(0.0, 0.0)
    {}
    SingleSphericalDomain(
    ...
    greens_functions::GreensFunction3DAbsSym const& gf() const noexcept {return gf_;}
    greens_functions::GreensFunction3DAbsSym&       gf()       noexcept {return gf_;}
  ...
  private:
    ...
    greens_functions::GreensFunction3DAbsSym gf_;
};
